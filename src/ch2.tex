  ...
  \item Identity
    ...
    \item $A$ has an identity element with respect to $O_8$.
      \begin{align*}
        ...
        e &= a
      \end{align*}
    \item $A$ does not have an identity element with respect to $O_9$.
    \item $A$ has an identity element with respect to $O_{10}$.
      \begin{align*}
        x*e &= x \\
        a*b &= a \\
        b*b &= b \\
        ...
        e &= b
      \end{align*}
    \item $A$ does not have an identity element with respect to $O_{11}$.
    \item $A$ does not have an identity element with respect to $O_{12}$.
    \item $A$ does not have an identity element with respect to $O_{13}$.
    \item $A$ does not have an identity element with respect to $O_{14}$.
    \item $A$ does not have an identity element with respect to $O_{15}$.
    \item $A$ does not have an identity element with respect to $O_{16}$.
    \end{itemize}
  \item Since $A$ only has identity elements with respect to $O_2$, $O_8$,
    and $O_{10}$, the rest cannot have inverses. As it turns out, with
...
\item {\bf Automata: The Algebra of Input/Output Sequences} \\
  ...
  \item $\lambda$ is the identity element for concatenation:
    $x\lambda = \lambda{}x = x$
  \end{enumerate}
  \todo[inline]{Prove that the empty sequence $\lambda$ is the identity element for concatenation.}
\end{enumerate}
